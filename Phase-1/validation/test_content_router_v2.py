...
REGISTRY = ROOT / "configs" / "content_router_v2.json"
...
def test_registry_forbids_selection_and_source_shortcuts() -> None:
    registry = json.loads(REGISTRY.read_text(encoding="utf-8"))

    assert registry["status"] == "candidate_audit_only"
    assert registry["authority"] == "shared_observable_metadata_only"
