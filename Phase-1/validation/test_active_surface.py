...
def test_active_python_files_are_limited_to_curation_surface() -> None:
    ...
    expected.add("quality_operating_points.py")
    ...
    expected.add("validation/test_quality_operating_points_v1.py")
    ...
    expected.add("redundancy_equivalence.py")
    expected.add("redundancy_mode_policy.py")
    expected.add("scripts/build_redundancy_v2_audit.py")
    expected.add("validation/test_redundancy_v2.py")
    expected.add("validation/test_redundancy_mode_policy_v1.py")
    ...
    expected.add("semantic_coverage_graph.py")
    expected.add("semantic_coverage_bundle.py")
    expected.add("semantic_embedding_runtime.py")
    expected.add("semantic_embedding_artifact.py")
    expected.add("stage_b_policy.py")
    expected.add("framework_consistency_audit.py")
    expected.add("final_experiment_preflight.py")
    expected.add("semantic_coverage_materializer.py")
    expected.add("semantic_neighbor_runtime.py")
    expected.add("semantic_coverage_empirical_audit.py")
    expected.add("semantic_coverage_corpus_runner.py")
    expected.add("coverage_rematerialization.py")
    expected.add("coverage_redundancy_bridge.py")
    expected.add("composition_artifacts.py")
    expected.add("scripts/build_coverage_engine_v2_audit.py")
    expected.add("scripts/build_semantic_coverage_v3_audit.py")
    expected.add("validation/test_coverage_engine_v2.py")
    expected.add("validation/test_semantic_coverage_graph_v3.py")
    expected.add("validation/test_semantic_embedding_runtime_v1.py")
    expected.add("validation/test_semantic_neighbor_runtime_v1.py")
    expected.add("validation/test_semantic_coverage_empirical_audit_v1.py")
    expected.add("validation/test_semantic_coverage_corpus_runner_v1.py")
    expected.add("validation/test_stage_b_policy_ownership_v1.py")
    expected.add("validation/test_framework_consistency_audit_v2.py")
    expected.add("validation/test_final_experiment_preflight_v1.py")
    expected.add("validation/test_semantic_coverage_materializer_v1.py")
    expected.add("validation/test_coverage_rematerialization_v3.py")
    expected.add("validation/test_composition_artifacts_v3.py")
...
def test_active_configs_are_limited_to_revised_contract() -> None:
    ...
    expected.add("semantic_coverage_v3.json")
    expected.add("semantic_coverage_code_7m_run_v1.json")
    expected.add("semantic_coverage_mixed_development_v1.json")
    expected.add("semantic_coverage_code_7m_final_normal_v1.json")
    expected.add("semantic_coverage_code_7m_final_hard_v1.json")
