...
def test_active_python_files_are_limited_to_curation_surface() -> None:
    ...
    expected.add("quality_teacher_fixtures.py")
    ...
    expected.add("validation/test_quality_teacher_runtime_v1.py")
    expected.add("validation/test_quality_teacher_smoke_v1.py")
    expected.add("validation/test_quality_teacher_fixture_matrix_v1.py")
    ...
    expected.add("benchmark_snapshot.py")
    ...
    expected.add("development_corpus_admission.py")
    expected.add("development_corpus_admission_alignment.py")
    expected.add("development_corpus_admission_contract.py")
    expected.add("development_corpus_benchmark_exclusion.py")
    expected.add("development_confirmatory_filter.py")
    ...
    expected.add("scripts/admit_development_corpus_v1.py")
    expected.add("scripts/filter_confirmatory_reference_v1.py")
    expected.add("validation/test_development_corpus_inventory_v1.py")
    expected.add("validation/test_development_corpus_admission_v1.py")
    expected.add("development_redundancy_gate.py")
