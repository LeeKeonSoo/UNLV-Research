...
def test_every_active_policy_has_executable_positive_and_false_positive_boundaries() -> None:
    ...
    active = [policy for policy in registry["policies"] if policy["status"] == "active"]
    ...
    for policy in active:
        ...
        assert policy["false_positive_fixture"] == "validation/fixtures/policy_fixture_contract_v1.json"
