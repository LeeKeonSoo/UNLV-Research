...
def _write_markdown(report: Dict[str, Any], path: Path) -> None:
    ...
    for dataset, payload in (report.get("datasets") or {}).items():
        lines.extend([
            ...
            "",
            "| Variant | Selected | Coverage | Quality | Learnability | Redundancy risk | Top-tail share | Domain sim | Style sim | Length sim | HQ recovered | Jaccard |",
            "|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|",
        ])
        ...
        lines.append("")
        lines.append("| Variant | dCoverage | dQuality | dLearnability | dRedundancy | dTopTail | dDomainSim | dStyleSim | dLengthSim |")
        lines.append("|---|---:|---:|---:|---:|---:|---:|---:|---:|")
        for variant, result in (payload.get("variant_results") or {}).items():
            ...
            lines.append(
                ...
                f"{float(delta.get('mean_learnability_support') or 0):+.4f} | {float(delta.get('mean_redundancy_risk') or 0):+.4f} | "
