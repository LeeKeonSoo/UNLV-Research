...
@dataclass(frozen=True, slots=True)
class SemanticCoverageAuditBundle:
    report: SemanticCoverageEmpiricalAudit
    primary_graph: dict[str, frozenset[str]]
    audit_graph: dict[str, frozenset[str]]
...
def build_empirical_audit_bundle(
    *,
    uids: tuple[str, ...],
    primary_vectors: NDArray[np.float32],
    audit_vectors: NDArray[np.float32],
    ...
    return SemanticCoverageAuditBundle(
        report=report,
...
def build_empirical_audit(
    *,
    ...
    return build_empirical_audit_bundle(
        uids=uids,
        ...
        primary_identity_sha256=primary_identity_sha256,
