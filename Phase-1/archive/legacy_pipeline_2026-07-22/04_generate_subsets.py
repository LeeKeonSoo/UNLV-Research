...
def main() -> int:
    ...
    parser.add_argument("--datasets", nargs="+", help="Optional scored dataset names to process.")
    args = parser.parse_args()
    manifest = generate_subsets(profiles_path=args.profiles, dataset_names=args.datasets)
