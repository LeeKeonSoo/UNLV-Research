...
MATURITY_POLICY: Dict[str, Dict[str, str]] = {
    ...
    "reference_quality_score": {
        "maturity": "High",
        "action": "Freeze",
        "method": "Reference-trained quality scorer with style/length-normalized evidence calibration",
        "notes": "Canonical Stage B quality rank signal; now calibrated for style/length bias and paired with mid-high quality-band preservation to avoid top-tail collapse.",
    },
    "exact_duplicate_indicator": {
        "maturity": "High",
        "action": "Freeze",
